...
샘 알트만은 ChatGPT가 최근 빠르게 성장했으며, 이에 규제 기관과 사회 모두가 관여해서 AI가 인류에게 미칠 수 있는 부정적 결과를 억제하는 데 기여해야 한다고 주장합니다. 그는 ChatGPT와 같은 생성형 모델이 대규모 허위 정보 생성과 사이버 공격 등 악의적으로 사용될 수 있음을 우려했습니다. 특히 GPT-4 모델은 기존 모델보다 추론 능력이 더 뛰어나므로, 허위 정보 생성 문제에 더 취약할 수 있습니다. 또한, 샘 알트만은 이러한 AI가 가까운 미래에 일부 일자리를 대체할 것으로 보고 있습니다. OpenAI는 GPT-4와 함께 애벌즈를 공개하면서, 이를 활용해 누구나 모델을 수정할 수 있게 되었습니다. GPT-4는 '멀티모달'을 통해 텍스트와 더불어 이미지를 이해하고 요구 사항을 처리할 수도 있습니다.  

### 느낀 점 :  

이 기사는 ChatGPT를 중심으로 그 기능과 시사점, AI에 내재된 부정적 영향, 이에 대한 사회적 관점에서의 대책을 설명하고 있습니다. 개인적으로 글의 제목은 'AI에 대한 두려움'으로 시작했지만, 그 내용의 일관성이 조금 부족했다고 생각합니다. 하지만 AI가 잠재적으로 가지고 있는 부정적 결과에 대한 우려는 모두 동의하는 내용이었습니다. 특히, 생성형 AI의 특성상 허위 정보가 대량으로 생성될 수 있다는 점은 매우 큰 문제로 와닿았습니다. ChatGPT는 정보를 기반으로 데이터를 생성하고, ChatGPT의 의견과 기재된 사실의 구분을 해주지 않는 걸 보았습니다. 이러한 점이 생성형 AI의 장점이자 단점이는 걸 느낄 수 있었습니다. 이러한 문제에 대처하기 위해 ChatGPT를 포함한 AI 프로그램 사용자 개개인의 피드백이 중요한 역할을 할 것 같습니다.  
